...
import (
	...
	"github.com/dora/ultron/console/jsre"
	"github.com/dora/ultron/console/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	flatten := "var dora = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Dora JavaScript console!\n\n")
	c.jsre.Run(`
